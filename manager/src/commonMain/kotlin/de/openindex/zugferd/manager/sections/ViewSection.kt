...
fun ViewSection(state: ViewSectionState) {
        ...
        Row(
            ...
            Column(
                ...
                AnimatedVisibility(visible = !isValid && isSelectedPdfArchiveUsable) {
                    Notification(
                        text = "Die Angaben zur Rechnung sind unvollständig. Eine E-Rechnung kann erst angezeigt werden, " +
...
@Composable
@OptIn(ExperimentalFoundationApi::class)
fun ViewSectionActions(state: ViewSectionState) {
    val scope = rememberCoroutineScope()
