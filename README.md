# OpenIndex ZUGFeRD-Manager 1.3.1
...
| [EXE-Installer](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-windows-x64.exe)<br>(x86_64) | [DMG-Archiv](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-macos-arm64.dmg)<br>(M1 oder neuer) | [DEB-Installer](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-linux-x64.deb)<br>(x86_64)    |
| [ZIP-Archiv](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-windows-x64.zip)<br>(x86_64)    | [DMG-Archiv](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-macos-x64.dmg)<br>(Intel)           | [RPM-Installer](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-linux-x64.rpm)<br>(x86_64)    |
|                                                                                                                                          |                                                                                                                                              | [TAR.GZ-Archiv](https://github.com/OpenIndex/ZUGFeRD-Manager/releases/download/v1.3.1/ZUGFeRD-Manager-1.3.1-linux-x64.tar.gz)<br>(x86_64) |
